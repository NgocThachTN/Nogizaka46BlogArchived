...
describe("deviceDetection", () => {
  ...
  it("detects iOS devices including iPad on MacIntel with touch", async () => {
    ...
    const mod1 = await import("./deviceDetection.js");
    ...
    const mod2 = await import("./deviceDetection.js");
  ...
  it("detects safari but not chrome", async () => {
    ...
    let mod = await import("./deviceDetection.js");
    ...
    mod = await import("./deviceDetection.js");
