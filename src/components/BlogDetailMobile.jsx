...
import {
  ...
  export default function BlogDetailMobile({
    ...
    const onScroll = useCallback(() => {
      ...
      const total = content.scrollHeight - wrap.clientHeight;
    ...
    if (loading) {
      return (
        ...
        >
          ...
          <ProCard
            ghost
            style={{ minHeight: "100dvh", background: "#fff", padding: 0, ...jpFont }}
      ...
      >
        ...
        <FloatButton.Group shape="square" style={{ right: 12, bottom: 12 }}>
          ...
          <FloatButton
            ...
            onClick={() => setDrawerVisible(true)}
          />
          <FloatButton.BackTop target={() => scrollWrapRef.current} icon={<ArrowUpOutlined />} tooltip="Lên đầu" />
        </FloatButton.Group>
